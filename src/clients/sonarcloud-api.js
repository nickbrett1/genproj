...
export class SonarCloudAPIService {
  ...
  async getProject(projectKey) {
    const response = await this.makeRequest(
      `/components/show?component=${projectKey}`,
    );
    return response.json();
  }
  ...
  async associateQualityGate(projectKey, qualityGateId) {
    console.log(
      `🔄 Associating quality gate ${qualityGateId} with project ${projectKey}`,
    );
  ...
  async getProjectQualityGate(projectKey) {
    const response = await this.makeRequest(
      `/qualitygates/get_by_project?project=${projectKey}`,
    );
    return response.json();
  }
  ...
  async listWebhooks(projectKey) {
    const response = await this.makeRequest(
      `/webhooks/list?project=${projectKey}`,
    );
    return response.json();
  }
  ...
  async getAnalysisStatus(projectKey) {
    const response = await this.makeRequest(
      `/ce/activity?component=${projectKey}`,
    );
    return response.json();
  }
