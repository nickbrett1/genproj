...
export class CircleCIAPIService extends BaseAPIService {
  ...
  async followProject(vcsType, organizationSlug, projectSlug) {
    console.log(
      `🔄 Following CircleCI project: ${organizationSlug}/${projectSlug}`,
    );

    const { attempts, baseDelayMs, maxDelayMs, backoffFactor } =
      this.followRetry;
    let lastError;
  ...
  async updateProjectSettings(
    ...
    console.log(
      `🔄 Updating CircleCI project settings: ${organizationSlug}/${projectSlug}`,
    );
    ...
    console.log(
      `✅ CircleCI project settings updated: ${organizationSlug}/${projectSlug}`,
    );
  ...
  async unfollowProject(vcsType, organizationSlug, projectSlug) {
    console.log(
      `🔄 Unfollowing CircleCI project: ${organizationSlug}/${projectSlug}`,
    );

    await this.makeRequest(
      `/project/${vcsType}/${organizationSlug}/${projectSlug}/unfollow`,
      {
        method: "DELETE",
      },
    );
    ...
    console.log(
      `✅ CircleCI project unfollowed: ${organizationSlug}/${projectSlug}`,
    );
  }
