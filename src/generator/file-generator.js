...
Binds 0.0.0.0:${harness.port}, answers GET ${harness.healthPath} with 200, and
serves the built frontend from ${harness.staticDirectory}. This is the *harness*
genproj guarantees: the container comes up, serves the UI, and passes its own
HEALTHCHECK. The wire protocol and business endpoints are yours - replace this
...
//! \`200\`, and serves the built frontend from \`${harness.staticDirectory}\`. This
//! is the *harness* genproj guarantees: the container comes up, serves the UI,
//! and passes its own HEALTHCHECK. The wire protocol and business endpoints are
//! yours - replace this file with your application.
//!
...
fn handle(mut stream: TcpStream) -> std::io::Result<()> {
    ...
    if path == HEALTH_PATH {
        return respond(&mut stream, 200, "text/plain; charset=utf-8", b"ok");
    }
