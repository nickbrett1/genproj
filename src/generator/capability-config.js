...
export class CapabilityConfigurationService {
  ...
  initializeCapabilities() {
    return {
      ...
      sveltekit: {
        ...
        name: "SvelteKit",
        description:
          "Modern web framework for building fast, reactive applications",
        category: "framework",
        dependencies: [],
        conflicts: [],
        configuration: {
      ...
      typescript: {
        ...
        name: "TypeScript",
        description:
          "Add TypeScript support for type safety and better development experience",
        category: "language",
        dependencies: [],
        conflicts: [],
        configuration: {
      ...
      docsify: {
        ...
        name: "Docsify",
        description:
          "Expose and preview project markdown documentation in a web browser",
        category: "maintenance",
  ...
  getCapabilitiesByCategory(category) {
    return Object.fromEntries(
      Object.entries(this.capabilities).filter(
