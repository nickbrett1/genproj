  ...
  "externalServices": [
    {
      ...
      "actions": [
        {
          "type": "create",
          "description": "GHCR package is created on first push from CircleCI"
        },
        {
          "type": "configure",
          "description": "Create a fine-grained PAT with Packages: read & write; add GHCR_USERNAME and GHCR_TOKEN to the CircleCI context"
        }
      ]
    }
  ],
