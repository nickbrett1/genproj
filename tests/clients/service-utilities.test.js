...
describe("service-utils", async () => {
  ...
  it("validates all tokens and handles failures", async () => {
    ...
    services.circleci.validateToken = vi
      .fn()
