...
AGENT_NAME="genproj-dev"
WORKSPACE="/workspaces/genproj"
...
if [ -x "/workspaces/genproj/scripts/agent-dev.sh" ]; then
  "/workspaces/genproj/scripts/agent-dev.sh" start >/dev/null 2>&1 || true
fi
POST_START_HOOK
}
